  ...
  const renderStepIndicator = () => (
    <div className="flex items-center justify-center mb-8">
      <div className="flex items-center">
        ...
        <div className={`w-20 h-1 ${step >= 3 ? 'bg-green-600' : 'bg-gray-200'}`} />
  ...
  const renderPaymentForm = () => (
    <form onSubmit={handleSubmitPayment} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full py-3 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition duration-200 disabled:bg-green-400"
      >
  ...
  const renderOrderComplete = () => (
    <div className="text-center py-8">
      ...
      <button
        ...
        className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200"
      >
